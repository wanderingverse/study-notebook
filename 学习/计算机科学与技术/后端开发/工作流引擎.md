[flowable 快速开始-CSDN](https://blog.csdn.net/zhipengfang/article/details/134690012)
[flowable 中文文档](https://flowable.me/)
[flowable 教程](https://www.bilibili.com/video/BV1oQ4y1J76o/?spm_id_from=333.337.search-card.all.click&vd_source=b67a8b73e04ba6b70c23e64bc43b4b94)
# 工作流概述
工作流是把业务之间的各个步骤以及规则进行抽象和概括性的描述。即使用特定的语言为业务流程建模，让其运行在计算机上，并让计算机进行计算和推动，是复杂版本的状态机。
